...
export default class Login {
  ...
  handleSubmitAdmin = (e) => {
    ...
    const user = {
      ...
      // [2 - Bug report - Login] - Unable to connect as Admin with the correct credentials - The Login.js test is red/FAIL
      // Error in console which redirects to this file (Login.js) / Bad selection of the input via data-testid
      // Correction: "admin" and not "employee" = OK (PASS test)
